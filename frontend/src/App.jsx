  ...
  return (
    <div className="app">
      ...
      <nav className="nav">
        ...
        <a href="#pros">Choisir un pro</a>
        <a href="#slots">Slots disponibles</a>
        <a href="#create">Créer des slots</a>
      ...
      <main className="single-page">
        ...
        <section className="card" id="pros">
          <div className="card-title">
        ...
        <section className="card" id="appointments">
          <div className="card-title">
